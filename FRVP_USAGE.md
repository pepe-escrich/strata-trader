...
3. Aparecerá una **capa transparente sobre el gráfico**
4. **Haz clic y arrastra** con el mouse para dibujar el rectángulo:
   - **Horizontal**: Define el período temporal (ej: últimas 3 horas, 2 días, etc.)
   - **Vertical**: Define el rango de precios a analizar
5. Suelta el botón para confirmar la selección

**Consejo:** Dibuja un rectángulo que cubra:
- Temporalmente: El período que quieres analizar
- Precio: El rango de precios relevante

**Nota**: Durante el modo dibujo, el gráfico NO responderá a pan/zoom hasta que termines o canceles
...
- ✅ Debe aparecer una capa transparente sobre el gráfico
- ✅ El cursor debe cambiar a cruz ✛
- ✅ Haz clic y ARRASTRA (no solo click)
- ✅ Arrastra al menos 10 píxeles para que se detecte
- ✅ Si no funciona, prueba hacer clic en "Cancelar" y vuelve a intentar
